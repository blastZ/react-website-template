...
class Product extends Component {
    componentDidMount() {
        document.addEventListener('scroll', () => {
            ...
            if(scrollTop >= 1500) {
                document.getElementById('pro_1').classList.add('wb-move-from-bottom', 'wb-show');
            }
            if(scrollTop >= 2100) {
                document.getElementById('pro_2').classList.add('wb-move-from-bottom', 'wb-show');
            }
            if(scrollTop >= 2700) {
                document.getElementById('pro_3').classList.add('wb-move-from-bottom', 'wb-show');
            }
            if(scrollTop >= 3300) {
                document.getElementById('pro_4').classList.add('wb-move-from-bottom', 'wb-show');
            }
        })
    }
