    ...
    state = {
        recruitments: [
            ...
            },
            {
                ...
                bodyTwo: [
                    '本科及以上学历，计算机、电子、自动化及通信等相关专业',
                    '独立进行客户交流，能提供方案咨询服务，准确挖掘客户的需求',
                    '独立执行方案撰写、需求引导，主持过标书系列文档的准备制作、演示及讲标',
                    '善于沟通及学习、性格外向、表达能力强、具备较高的悟性，做事认真、注重细节'
                ]
            },
            {
                title: '行政助理',
        ...
        return (
            <div className="bgimg-4">
                <div className="w3-center flex-box w3-container" style={{width: '100%', height: '300px', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
                    ...
                    <h3 className="w3-text-white">邮箱:hr@codvision.com</h3>
                </div>
                <div className="w3-content w3-padding-32" id="wb-recruitment-content">{
                    this.state.recruitments.map((recruitment, index) => (
                        <div key={recruitment.title + index} className={`w3-row w3-card-4 w3-round w3-text-white wb-blue ${index === 0 ? null : 'wb-margin-top-64'}`} style={{position: 'relative', borderRadius: '10px'}}>
